...
const supabaseUrl = process.env.NEXT_PUBLIC_SUPABASE_URL || 'https://zfoufwqtntqbzsydykgw.supabase.co';
const supabaseAnonKey = process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inpmb3Vmd3F0bnRxYnpzeWR5a2d3Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDQ1MzUyNDYsImV4cCI6MjA2MDExMTI0Nn0.KD5syt4CylQrCBBrCBPT9zl1jrZ9-ZANemZosLjAGgE';

// Check environment variables and log a warning if missing
